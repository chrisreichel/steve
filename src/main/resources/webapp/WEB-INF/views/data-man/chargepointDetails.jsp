    ...
    <section><span>
        ...
        <table class="table table-sm">
            ...
            <tr>
                <td>Transactions:</td>
                <td>
                    <a class="btn btn-outline-primary btn-sm" href="${ctxPath}/manager/transactions/query?chargeBoxId=${chargePointForm.chargeBoxId}&amp;type=ACTIVE">ACTIVE</a>
                     /
                    <a class="btn btn-outline-primary btn-sm" href="${ctxPath}/manager/transactions/query?chargeBoxId=${chargePointForm.chargeBoxId}&amp;type=ALL">ALL</a>
                </td>
            </tr>
            <tr>
                <td>Reservations:</td>
                <td>
                    <a class="btn btn-outline-primary btn-sm" href="${ctxPath}/manager/reservations/query?chargeBoxId=${chargePointForm.chargeBoxId}&amp;periodType=ACTIVE">ACTIVE</a>
                </td>
            </tr>
            <tr>
                <td>Connector Status:</td>
                <td>
                    <a class="btn btn-outline-primary btn-sm" href="${ctxPath}/manager/home/connectorStatus/query?chargeBoxId=${chargePointForm.chargeBoxId}">ALL</a>
                </td>
            </tr>
            <tr>
                <td>Charging Profiles:</td>
                <td>
                    <a class="btn btn-outline-primary btn-sm" href="${ctxPath}/manager/chargingProfiles/assignments?chargeBoxId=${chargePointForm.chargeBoxId}">ALL</a>
                </td>
            </tr>
            </tbody>
        </table>
        ...
        <form:form action="${ctxPath}/manager/chargepoints/update" modelAttribute="chargePointForm">
            ...
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2">Insert connector status after start/stop transaction:&nbsp;
